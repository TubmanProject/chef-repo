...
apps.each do |app|
  ...
  app_settings['SSL_CERTFILE'] = "#{node['app']['directories']['ssl']}/#{app['subdomain']}.#{app['domain']}/ssl.pem"
  app_settings['SSL_KEYFILE'] = "#{node['app']['directories']['ssl']}/#{app['subdomain']}.#{app['domain']}/ssl.key"
